...
import { P as ProtocolError, T as TimeoutWaitingForResponseErrorCode, O as utf8ToBytes, Q as ExternalError, V as MissingRootKeyErrorCode, W as Certificate, X as lookupResultToBuffer, Y as RequestStatusResponseStatus, Z as UnknownError, _ as RequestStatusDoneNoReplyErrorCode, $ as RejectError, a0 as CertifiedRejectErrorCode, a1 as UNREACHABLE_ERROR, a2 as InputError, a3 as InvalidReadStateRequestErrorCode, a4 as ReadRequestType, a5 as Principal, a6 as IDL, a7 as MissingCanisterIdErrorCode, a8 as HttpAgent, a9 as encode, aa as QueryResponseStatus, ab as UncertifiedRejectErrorCode, ac as isV3ResponseBody, ad as isV2ResponseBody, ae as UncertifiedRejectUpdateErrorCode, af as UnexpectedErrorCode, ag as decode, S as Subscribable, ah as pendingThenable, ai as resolveEnabled, z as shallowEqualObjects, aj as resolveStaleTime, I as noop, ak as environmentManager, al as isValidTimeout, am as timeUntilStale, an as timeoutManager, ao as focusManager, ap as fetchState, aq as replaceData, G as notifyManager, d as reactExports, J as shouldThrowError, H as useQueryClient, g as useInternetIdentity, ar as createActorWithConfig, as as Record, at as Opt, au as Variant, av as Vec, aw as Tuple, ax as Service, ay as Func, az as Nat, aA as Text, aB as Nat8, aC as Bool, aD as Null, aE as Principal$1, aF as Int } from "./index--tQIKzjM.js";
...
const AnalyticsData = Record({
  "notesPerDay": Vec(Tuple(Text, Nat)),
  "activeStudents": Nat,
  "papersPerDepartment": Vec(Tuple(Text, Nat)),
  "totalDownloads": Nat
});
const DashboardStats = Record({
  ...
  "recentNotes": Vec(Note)
});
const NoteFilters = Record({
  "semester": Opt(Nat),
  "subject": Opt(Text),
  "unit": Opt(Text),
  "year": Opt(Nat),
...
const QuestionPaperInput = Record({
  "semester": Nat,
  "subject": Text,
  "regulation": Text,
  "year": Nat,
...
Service({
  ...
  "createNote": Func([NoteInput], [Opt(Note)], []),
  "deleteNote": Func([Nat], [Bool], []),
  "generateAISummary": Func([Text], [Opt(Text)], []),
  "getAnalytics": Func([Nat], [AnalyticsData], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getDashboardStats": Func([], [DashboardStats], ["query"]),
  "getNote": Func([Nat], [Opt(Note)], ["query"]),
  "getNotes": Func(
    [NoteFilters, Nat, Nat],
    [Record({ "total": Nat, "notes": Vec(Note) })],
    ["query"]
  ),
  "getQuestionPapers": Func(
    [NoteFilters, Nat, Nat],
    [Record({ "total": Nat, "papers": Vec(QuestionPaper) })],
    ["query"]
  ),
  "getStudents": Func([], [Vec(UserProfile)], ["query"]),
  "getUserProfile": Func([], [Opt(UserProfile)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "isOpenAIConfigured": Func([], [Bool], ["query"]),
  "searchNotes": Func([Text, NoteFilters], [Vec(Note)], ["query"]),
  "searchQuestionPapers": Func(
    [Text],
    [Vec(QuestionPaper)],
    ["query"]
  ),
  "setOpenAIApiKey": Func([Text], [], []),
  "setUserProfile": Func([Text], [UserProfile], []),
  "summarizeTranscript": Func([Text], [Opt(Text)], []),
  "updateNote": Func([Nat, NoteInput], [Opt(Note)], []),
  "uploadQuestionPaper": Func(
    [QuestionPaperInput],
    [Opt(QuestionPaper)],
    []
  )
...
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const AnalyticsData2 = IDL2.Record({
    "notesPerDay": IDL2.Vec(IDL2.Tuple(IDL2.Text, IDL2.Nat)),
    "activeStudents": IDL2.Nat,
    "papersPerDepartment": IDL2.Vec(IDL2.Tuple(IDL2.Text, IDL2.Nat)),
    "totalDownloads": IDL2.Nat
  });
  const DashboardStats2 = IDL2.Record({
    "totalStudents": IDL2.Nat,
    "totalSubjects": IDL2.Nat,
    "totalNotes": IDL2.Nat,
    "totalQuestionPapers": IDL2.Nat,
    "recentNotes": IDL2.Vec(Note2)
  });
  const NoteFilters2 = IDL2.Record({
    "semester": IDL2.Opt(IDL2.Nat),
    "subject": IDL2.Opt(IDL2.Text),
    "unit": IDL2.Opt(IDL2.Text),
    "year": IDL2.Opt(IDL2.Nat),
    "department": IDL2.Opt(IDL2.Text)
  });
  const QuestionPaper2 = IDL2.Record({
    "id": IDL2.Nat,
    "semester": IDL2.Nat,
    "subject": IDL2.Text,
    "regulation": IDL2.Text,
    "createdAt": Timestamp2,
    "year": IDL2.Nat,
    "paperType": IDL2.Text,
    "department": IDL2.Text,
  ...
  const QuestionPaperInput2 = IDL2.Record({
    "semester": IDL2.Nat,
    "subject": IDL2.Text,
    "regulation": IDL2.Text,
    "year": IDL2.Nat,
  ...
  return IDL2.Service({
    ...
    "createNote": IDL2.Func([NoteInput2], [IDL2.Opt(Note2)], []),
    "deleteNote": IDL2.Func([IDL2.Nat], [IDL2.Bool], []),
    "generateAISummary": IDL2.Func([IDL2.Text], [IDL2.Opt(IDL2.Text)], []),
    "getAnalytics": IDL2.Func([IDL2.Nat], [AnalyticsData2], ["query"]),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getDashboardStats": IDL2.Func([], [DashboardStats2], ["query"]),
    "getNote": IDL2.Func([IDL2.Nat], [IDL2.Opt(Note2)], ["query"]),
    "getNotes": IDL2.Func(
      [NoteFilters2, IDL2.Nat, IDL2.Nat],
      [IDL2.Record({ "total": IDL2.Nat, "notes": IDL2.Vec(Note2) })],
      ["query"]
    ),
    "getQuestionPapers": IDL2.Func(
      [NoteFilters2, IDL2.Nat, IDL2.Nat],
      [IDL2.Record({ "total": IDL2.Nat, "papers": IDL2.Vec(QuestionPaper2) })],
      ["query"]
    ),
    "getStudents": IDL2.Func([], [IDL2.Vec(UserProfile2)], ["query"]),
    "getUserProfile": IDL2.Func([], [IDL2.Opt(UserProfile2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "isOpenAIConfigured": IDL2.Func([], [IDL2.Bool], ["query"]),
    "searchNotes": IDL2.Func(
      [IDL2.Text, NoteFilters2],
      [IDL2.Vec(Note2)],
      ["query"]
    ),
    "searchQuestionPapers": IDL2.Func(
      [IDL2.Text],
      [IDL2.Vec(QuestionPaper2)],
      ["query"]
    ),
    "setOpenAIApiKey": IDL2.Func([IDL2.Text], [], []),
    "setUserProfile": IDL2.Func([IDL2.Text], [UserProfile2], []),
    "summarizeTranscript": IDL2.Func([IDL2.Text], [IDL2.Opt(IDL2.Text)], []),
    "updateNote": IDL2.Func([IDL2.Nat, NoteInput2], [IDL2.Opt(Note2)], []),
    "uploadQuestionPaper": IDL2.Func(
      [QuestionPaperInput2],
      [IDL2.Opt(QuestionPaper2)],
      []
    )
  });
};
...
class Backend {
  ...
  async getQuestionPapers(arg0, arg1, arg2) {
    if (this.processError) {
      try {
  ...
  async searchQuestionPapers(arg0) {
    if (this.processError) {
      try {
  ...
  async summarizeTranscript(arg0) {
    if (this.processError) {
      try {
  ...
  async uploadQuestionPaper(arg0) {
    if (this.processError) {
      try {
...
function to_candid_NoteFilters_n14(_uploadFile, _downloadFile, value) {
...
async function getNotes(filters, page, pageSize = 10) {
...
async function searchNotes(query, filters) {
  return getActor().searchNotes(query, filters);
}
async function getQuestionPapers(filters, page, pageSize = 10) {
...
async function uploadQuestionPaper(input) {
...
async function setUserProfile(name) {
...
export {
  setUserProfile as a,
  uploadQuestionPaper as b,
  createActor as c,
  createNote as d,
  updateNote as e,
  deleteNote as f,
  getUserProfile as g,
  summarizeTranscript as h,
  setOpenAIApiKey as i,
  useQuery as j,
  getNotes as k,
  getNote as l,
  searchNotes as m,
  getQuestionPapers as n,
  searchQuestionPapers as o,
  getDashboardStats as p,
  getStudents as q,
  getAnalytics as r,
  setActor as s,
  isOpenAIConfigured as t,
  useActor as u
};
